...
const headComponents = [
  <title key={0}>Conduit</title>,
  <meta key={1} name="description" content="Generated by create next app" />,
  <link
    key={2}
    rel="stylesheet"
    type="text/css"
  ...
  />,
  <link key={4} rel="stylesheet" href="//demo.productionready.io/main.css" />,
  <link
    key={5}
    rel="icon"
